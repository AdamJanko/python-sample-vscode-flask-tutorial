...
[![Build Status](https://dev.azure.com/adamjankowiak/test/_apis/build/status/AdamJanko.Test_5?branchName=master)](https://dev.azure.com/adamjankowiak/test/_build/latest?definitionId=4&branchName=master)
